...
public class Screen {
	...
	public void drawGameOver(Graphics g, int points) {
		...
		drawCenteredString("GAME OVER :((", getRealWidth(), getRealHeight() ,-(Game.TILES_SIZE*2), g);
		font = new Font("Arial", Font.PLAIN, 10 * Game.SCALE);
		g.setFont(font);
		g.setColor(Color.yellow);
		drawCenteredString("POINTS: " + points, getRealWidth(), getRealHeight() + (Game.TILES_SIZE * 2) * Game.SCALE,0, g);
		
		font = new Font("Arial", Font.PLAIN, 5 * Game.SCALE);
		g.setFont(font);
		g.setColor(Color.white);
		drawCenteredString("[Press space to replay]", getRealWidth(), getRealHeight() + (Game.TILES_SIZE * 4) * Game.SCALE,0, g);
	...
	public void drawVictory(Graphics g, int points) {
		...
		g.setFont(font);
		g.setColor(Color.white);
		drawCenteredString("VICTORY !!!", getRealWidth(), getRealHeight() ,-(Game.TILES_SIZE*2), g);
		font = new Font("Arial", Font.PLAIN, 10 * Game.SCALE);
		g.setFont(font);
		g.setColor(Color.yellow);
		drawCenteredString("POINTS: " + points, getRealWidth(), getRealHeight() + (Game.TILES_SIZE * 2) * Game.SCALE,0, g);
